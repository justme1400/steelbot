...
cl.login(token="EoypYB2rJZlPgpkQk4E5.j+/0/vFmimIg3h78o1Rpbq.1A5z1EQpEudlpbEbb4k9B6DCKs+dNuYKJd1oAX6AWyM=")
cl.loginResult()

ki = LINETCR.LINE() #Zorro
ki.login(token="TokenBot")
ki.loginResult()

kk = LINETCR.LINE() #Sanji
kk.login(token="TokenBot")
kk.loginResult()

kc = LINETCR.LINE() #Ussop
kc.login(token="TokenBot")
kc.loginResult()

ks = LINETCR.LINE() #Chooper
ks.login(token="TokenBot")
ks.loginResult()

ka = LINETCR.LINE() #Franky
ka.login(token="TokenBot")
ka.loginResult()

kb = LINETCR.LINE() #Brook
kb.login(token="TokenBot")
kb.loginResult()

ku = LINETCR.LINE() #Nami
ku.login(token="TokenBot")
ku.loginResult()

ke = LINETCR.LINE() #Robin
ke.login(token="TokenBot")
ke.loginResult()

ko = LINETCR.LINE() # Jinbei
ko.login(token="TokenBot")
ko.loginResult()

satpam= LINETCR.LINE() # 
satpam.login(token="TokenBot")
satpam.loginResult()

k1 = LINETCR.LINE() #Backup 1
k1.login(token="TokenBot")
k1.loginResult()
...
║1 Selfbot 2 Bot Assist → 70K/Bulan
║1 Selfbot 3 Bot Assist → 90K/Bulan
║1 Selfbot 4 Bot Assist → 100K/Bulan
║1 Selfbot 5 Bot Assist → 120K/Bulan
║1 Selfbot 6 Bot Assist → 140K/Bulan
║1 Selfbot 7 Bot Assist → 160K/Bulan
║1 Selfbot 8 Bot Assist → 180K/Bulan
║1 Selfbot 9 Bot Assist → 190K/Bulan
║1 Selfbot 10 Bot Assist → 200K/Bulan
║
║→Out Of Indonesia←
║1 Selfbot 1 Bot Assist → 5$ USD/Month
║1 Selfbot 2 Bot Assist → 7$ USD/Month
║1 Selfbot 3 Bot Assist → 9$ USD/Month
║1 Selfbot 4 Bot Assist → 10$ USD/Month
║1 Selfbot 5 Bot Assist → 120$ USD/Month
║1 Selfbot 6 Bot Assist → 14$ USD/Month
║1 Selfbot 7 Bot Assist → 16$ USD/Month
║1 Selfbot 8 Bot Assist → 18$ USD/Month
║1 Selfbot 9 Bot Assist → 19$ USD/Month
║1 Selfbot 10 Bot Assist → 20$ USD/Month
║
║
...
║http://line.me/ti/p/~prasetyo.86
║http://line.me/ti/p/~agus_0070
║════════════════════
║____[★]૦Ո૯ ƿɿ૯८૯ ੮૯คɱ[★]____
╚════════════════════"""

About = """╔═════════════
║One Piece Bot Version 2.6║
╚═════════════"""

KAC=[cl,ki,kk,kc,ks,ka,kb,ku,ke,ko]
...
#Pmid = pras.getProfile().mid
#Pmid1 = p1.getProfile().mid
#Pmid2 = p2.getProfile().mid
#Pmid3 = p3.getProfile().mid
#Pmid4 = p4.getProfile().mid
#Pmid5 = p5.getProfile().mid
mid1 = k1.getProfile().mid
mid2 = k2.getProfile().mid

Bots=[mid,Amid,Bmid,Cmid,Dmid,Emid,Fmid,Gmid,Hmid,Imid,Smid,mid1,mid2]
admin=["udbced270da88de4b93ca0d64e83cecc9"] #Your Mid
owner=["udbced270da88de4b93ca0d64e83cecc9"] #Your Mid
whitelist=["u5ec213324a121275d32f47c14bc8f5c0"] #your Friends Mid
wait = {
    'contact':False,
    'autoJoin':True,
...
def bot(op):
          ...
          if mid in op.param3:
            if wait["autoJoin"] == True:
              if op.param2 in owner:
                ...
                #p1.acceptGroupInvitationByTicket(op.param1,Ticket)
                #p2.acceptGroupInvitationByTicket(op.param1,Ticket)
                #p3.acceptGroupInvitationByTicket(op.param1,Ticket)
                #p4.acceptGroupInvitationByTicket(op.param1,Ticket)
                #p5.acceptGroupInvitationByTicket(op.param1,Ticket)
  ...
  #------Joined User Kick start------#
            ...
            if op.param3 in mid:
              if op.param2 not in Bots or owner:
                try:
                  ...
                  time.sleep(0.00001)
                  #pras.acceptGroupInvitationByTicket(op.param1,Ticket)
                  #time.sleep(0.00001)
                  ku.acceptGroupInvitationByTicket(op.param1,Ticket)
                  time.sleep(0.00001)
                    ...
                    if msg.text is not None:
                        ...
                        if data['status'] == 200:
                            if data['result']['result'] == 100:
                                cl.sendText(msg.to, "[One Piece Chat] " + "\n" + data['result']['response'].encode('utf-8'))
        ...
        if op.type == 25:
            ...
            if msg.contentType == 13:
              if wait["winvite"] == True:
                  ...
                  _name = msg.contentMetadata["displayName"]
                  invite = msg.contentMetadata["mid"]
                  groups = ku.getGroup(msg.to)
                  pending = groups.invitee
                  targets = []
                  for s in groups.members:
                    if _name in s.displayName:
                      ku.sendText(msg.to,"-> " + _name + " was here")
                      break
                    elif invite in wait["blacklist"]:
                      ku.sendText(msg.to,"Sorry, " + _name + " On Blacklist")
                      ku.sendText(msg.to,"Remove User From Blacklist Boss !!!" + invite)
                      break
                    else:
                      targets.append(invite)
                  if targets == []:
                    ...
                    for target in targets:
                      try:
                        ...
                        ku.inviteIntoGroup(msg.to,[target])
                        ku.sendText(msg.to,"Already Invited Boss💋: \n➡" + _name)
                        wait["winvite8"] = False
                        break
                      except:
                        try:
                          ku.findAndAddContactsByMid(invite)
                          ku.inviteIntoGroup(op.param1,[invite])
                          wait["winvite8"] = False
                        except:
                          try:
                            ku.findAndAddContactsByMid(invite)
                            ku.inviteIntoGroup(op.param1,[invite])
                            wait["winvite8"] = False
                            ku.sendText(msg.to,"Suck`es hahahahaha💋: \n➡" + _name)
                            break
                          except:
                            try:
                              ku.findAndAddContactsByMid(invite)
                              ku.inviteIntoGroup(op.param1,[invite])
                              wait["winvite8"] = False
                              ku.sendText(msg.to,"Done ✔ Boss 💋 \n➡" + _name)
                              break
                            except:
                              ku.sendText(msg.to,"Negative, Error detected")
                              wait["winvite8"] = False
                              break
                  ...
                  _name = msg.contentMetadata["displayName"]
                  invite = msg.contentMetadata["mid"]
                  groups = ko.getGroup(msg.to)
                  pending = groups.invitee
                  targets = []
                  for s in groups.members:
                    if _name in s.displayName:
                      ko.sendText(msg.to,"-> " + _name + " was here")
                      break
                    elif invite in wait["blacklist"]:
                      ko.sendText(msg.to,"Sorry, " + _name + " On Blacklist")
                      ko.sendText(msg.to,"Remove User From Blacklist Boss !!!" + invite)
                      break
                    else:
                      targets.append(invite)
                  if targets == []:
                    ...
                    for target in targets:
                      try:
                        ...
                        ko.inviteIntoGroup(msg.to,[target])
                        ko.sendText(msg.to,"Already Invited Boss💋: \n➡" + _name)
                        wait["winvite10"] = False
                        break
                      except:
                        try:
                          ko.findAndAddContactsByMid(invite)
                          ko.inviteIntoGroup(op.param1,[invite])
                          wait["winvite10"] = False
                        except:
                          try:
                            ko.findAndAddContactsByMid(invite)
                            ko.inviteIntoGroup(op.param1,[invite])
                            wait["winvite10"] = False
                            ko.sendText(msg.to,"Suck`es hahahahaha💋: \n➡" + _name)
                            break
                          except:
                            try:
                              ko.findAndAddContactsByMid(invite)
                              ...
                              ko.sendText(msg.to,"Negative, Error detected")
                              wait["winvite10"] = False
                              break
                ...
                if targets == []:
                   ...
                   for target in targets:
                        try:
                            ...
                            ke.findAndAddContactsByMid(target)
                            ko.findAndAddContactsByMid(target)
                            #p1.findAndAddContactsByMid(target)
                            #p2.findAndAddContactsByMid(target)
                            #p3.findAndAddContactsByMid(target)
                            #p4.findAndAddContactsByMid(target)
                            #p5.findAndAddContactsByMid(target)
                            admin.append(target)
    ...
    #-------------- Add Friends -----------
              ...
              if msg.from_ in owner:
                if msg.toType == 2:
                  ...
                  #gs = p1.getGroup(msg.to)
                  #gs = p2.getGroup(msg.to)
                  #gs = p3.getGroup(msg.to)
                  #gs = p4.getGroup(msg.to)
                  #gs = p5.getGroup(msg.to)
                  targets = []
                  for g in gs.members:
                    if _nametarget == g.displayName:
                      targets.append(g.mid)
    ...
    #--------------= SC Ganti nama Owner=--------------
            ...
            #elif "Prasname:" in msg.text:
              #if msg.from_ in owner:
                #string = msg.text.replace("Prasname:","")
                #if len(string.decode('utf-8')) <= 6000000000:
                    #profile = pras.getProfile()
                    #profile.displayName = string
                    #pras.updateProfile(profile)
                    #pras.sendText(msg.to,"Update Name Menjadi : " + string + "")
    #-------------- copy profile----------
  ...
  #-----------------=Selesai=------------------
              ...
              if msg.from_ in admin:
                ...
                ku.sendText(msg.to,Gmid)
                ke.sendText(msg.to,Hmid)
                ko.sendText(msg.to,Imid)
                #p1.sendText(msg.to,Pmid1)
                #p2.sendText(msg.to,Pmid2)
                #p3.sendText(msg.to,Pmid3)
                #p4.sendText(msg.to,Pmid4)
                #p5.sendText(msg.to,Pmid5)
              else:
                cl.sendText(msg.to,"This Command Only For Admin & Owner")
...
#---------------------Sc invite owner ke group------
            ...
            elif "6Invite me" in msg.text:
              if msg.from_ in owner:
                ka.sendText(msg.to, "Okay Boss !!!\nI Will Invite You To All Groups Boss")
                gid = ka.getGroupIdsJoined()
              for i in gid:
                ka.findAndAddContactsByMid(msg.from_)
                ka.inviteIntoGroup(i,[msg.from_])
            elif "7Invite me" in msg.text:
              if msg.from_ in owner:
                kb.sendText(msg.to, "Okay Boss !!!\nI Will Invite You To All Groups Boss")
                gid = kb.getGroupIdsJoined()
              for i in gid:
                kb.findAndAddContactsByMid(msg.from_)
                kb.inviteIntoGroup(i,[msg.from_])
            elif "8Invite me" in msg.text:
              if msg.from_ in owner:
                ku.sendText(msg.to, "Okay Boss !!!\nI Will Invite You To All Groups Boss")
                gid = ku.getGroupIdsJoined()
              for i in gid:
                ku.findAndAddContactsByMid(msg.from_)
                ku.inviteIntoGroup(i,[msg.from_])
            elif "9Invite me" in msg.text:
              if msg.from_ in owner:
                ke.sendText(msg.to, "Okay Boss !!!\nI Will Invite You To All Groups Boss")
                gid = ke.getGroupIdsJoined()
              for i in gid:
                ke.findAndAddContactsByMid(msg.from_)
                ke.inviteIntoGroup(i,[msg.from_])
            elif "10Invite me" in msg.text:
              if msg.from_ in owner:
                ko.sendText(msg.to, "Okay Boss !!!\nI Will Invite You To All Groups Boss")
                gid = ko.getGroupIdsJoined()
              for i in gid:
                ko.findAndAddContactsByMid(msg.from_)
                ko.inviteIntoGroup(i,[msg.from_])
        ...
        #----------------Fungsi Join Group Start-----------------------#
              ...
              if msg.from_ in owner:
                ...
                time.sleep(0.00001)
                #p1.acceptGroupInvitationByTicket(msg.to,Ticket)
                #time.sleep(0.00001)
                #p2.acceptGroupInvitationByTicket(msg.to,Ticket)
                #time.sleep(0.00001)
                #p3.acceptGroupInvitationByTicket(msg.to,Ticket)
                #time.sleep(0.00001)
                #p4.acceptGroupInvitationByTicket(msg.to,Ticket)
                #time.sleep(0.00001)
                #p5.acceptGroupInvitationByTicket(msg.to,Ticket)
                #time.sleep(0.00001)
                G = cl.getGroup(msg.to)
                G.preventJoinByTicket = True
                cl.updateGroup(G)
              ...
              if msg.from_ in owner:
                if msg.toType == 2:
                    ...
                    try:
                        ...
                        #p1.leaveGroup(msg.to)
                        #p2.leaveGroup(msg.to)
                        #p3.leaveGroup(msg.to)
                        #p4.leaveGroup(msg.to)
                        #p5.leaveGroup(msg.to)
    ...
    #-------------Fungsi Tag All Finish---------------#
        ...
        #----------------Fungsi Banned Kick Target Finish----------------------#                
            ...
            elif "Anjingg" in msg.text:
              if msg.from_ in owner:
                if msg.toType == 2:
                    print "ok"
                    _name = msg.text.replace("Anjingg","")
                    gs = cl.getGroup(msg.to)
                    gs = ki.getGroup(msg.to)
                    gs = kk.getGroup(msg.to)
                    gs = kc.getGroup(msg.to)
                    ...
                    ki.sendText(msg.to,"One Piece Team Mau Bersih² Group Sampah Nih")
                    kk.sendText(msg.to,"Karna Ini Group Sampah Jadi Mau Di Bersihin Dulu Yah\n★Jangan Baper...\n★Jangan Nangis\n★Jangan Cengeng\nBawa Enjoy Aja Kawan♪")
                    kc.sendText(msg.to,"★Inget Baik² Nih Logo Team War Kami★\n\n★★★૦Ո૯ ƿɿ૯८૯ ੮૯คɱ★★★")
                    ks.sendImageWithUrl(msg.to,"http://oi67.tinypic.com/j5a0wl.jpg")
                    ka.sendImageWithUrl(msg.to,"http://oi65.tinypic.com/2m5ndac.jpg")
                    kb.sendImageWithUrl(msg.to,"http://oi66.tinypic.com/xpoiet.jpg")
                    ku.sendImageWithUrl(msg.to,"http://oi65.tinypic.com/29eorc3.jpg")
                    ...
                    ke.sendMessage(msg)
                    ko.sendText(msg.to,"This My Team WAR")
                    targets = []
                    for g in gs.members:
        ...
        #-------------Fungsi Broadcast Start------------#
              ...
              if msg.from_ in owner:
                ...
                #a = p2.getGroupIdsJoined()
                #a = p3.getGroupIdsJoined()
                #a = p4.getGroupIdsJoined()
                #a = p5.getGroupIdsJoined()
                for taf in a:
                  ...
                  #p2.sendText(taf, (bctxt))
                  #p3.sendText(taf, (bctxt))
                  #p4.sendText(taf, (bctxt))
                  #p5.sendText(taf, (bctxt))
      ...
      #--------------List Group------------
       #------------ Keluar Dari Semua Group------
              ...
              if msg.from_ in owner:
                ...
                gid = ke.getGroupIdsJoined()
                gid = ku.getGroupIdsJoined()
                #gid = p1.getGroupIdsJoined()
                #gid = p2.getGroupIdsJoined()
                #gid = p3.getGroupIdsJoined()
                #gid = p4.getGroupIdsJoined()
                #gid = p5.getGroupIdsJoined()
                for i in gid:
                  ku.leaveGroup(i)
                  ke.leaveGroup(i)
                  ko.leaveGroup(i)
...
#-----------------------------------------------
       ...
       #-------------Fungsi Respon Start---------------------#
              ...
              if msg.from_ in admin:
                ...
                kb.sendText(msg.to,"ブルック")
                ku.sendText(msg.to,"ナミ")
                ke.sendText(msg.to,"ロビン")
                ko.sendText(msg.to,"ジンベ")
                #p1.sendText(msg.to,"ジーンズ")
                #p2.sendText(msg.to,"エッチャ")
                #p3.sendText(msg.to,"インエイツ")
                #p4.sendText(msg.to,"ジー")
                #p5.sendText(msg.to,"ケリーリン")
    ...
    #-------------Fungsi Respon Finish---------------------#   
              ...
              if msg.from_ in owner:
                wait["winvite8"] = True
                ku.sendText(msg.to,"Share contact boss 😎")
              ...
              if msg.from_ in owner:
                wait["winvite10"] = True
                ko.sendText(msg.to,"Share contact boss 😎")
              ...
              if msg.toType == 2:
                ...
                for angkut in ready:
                  try:
                    ...
                    ki.inviteIntoGroup(msg.to,[angkut])
            elif msg.text in ["SanjiSpamInvite"]:
              if msg.toType == 2:
                #siap = cl.getGroup(msg.to)
                ...
                for angkut in ready:
                  try:
                    ...
                    kk.inviteIntoGroup(msg.to,[angkut])
            elif msg.text in ["UssopSpamInvite"]:
              if msg.toType == 2:
                #siap = cl.getGroup(msg.to)
              ...
              if msg.toType == 2:
                ...
                for angkut in ready:
                  try:
                    ...
                    ks.inviteIntoGroup(msg.to,[angkut])
            elif msg.text in ["FrankySpamInvite"]:
              if msg.toType == 2:
                #siap = cl.getGroup(msg.to)
                ready = ka.getAllContactIds()
                for angkut in ready:
                  try:
                    ka.inviteIntoGroup(msg.to,[angkut])
                  except:
                    ka.inviteIntoGroup(msg.to,[angkut])
            elif msg.text in ["BrookSpamInvite"]:
              if msg.toType == 2:
                #siap = cl.getGroup(msg.to)
                ready = kb.getAllContactIds()
                for angkut in ready:
                  try:
                    kb.inviteIntoGroup(msg.to,[angkut])
                  except:
                    kb.inviteIntoGroup(msg.to,[angkut])
            elif msg.text in ["NamiSpamInvite"]:
              if msg.toType == 2:
                #siap = cl.getGroup(msg.to)
                ready = ku.getAllContactIds()
                for angkut in ready:
                  try:
                    ku.inviteIntoGroup(msg.to,[angkut])
                  except:
                    ku.inviteIntoGroup(msg.to,[angkut])
            elif msg.text in ["RobinSpamInvite"]:
              if msg.toType == 2:
                #siap = cl.getGroup(msg.to)
                ready = ke.getAllContactIds()
                for angkut in ready:
                  try:
                    ke.inviteIntoGroup(msg.to,[angkut])
                  except:
                    ke.inviteIntoGroup(msg.to,[angkut])
            elif msg.text in ["JinbeiSpamInvite"]:
              if msg.toType == 2:
                #siap = cl.getGroup(msg.to)
                ready = ko.getAllContactIds()
                for angkut in ready:
                  try:
                    ko.inviteIntoGroup(msg.to,[angkut])
                  except:
                    ko.inviteIntoGroup(msg.to,[angkut])     
      ...
      #-------------Fungsi Banned Send Contact Finish------------------#
              ...
              p1.sendMessage(msg)
              p1.sendText(msg.to,"======================")
              p1.sendImageWithUrl("http://oi65.tinypic.com/2rp38ub.jpg")
    ...
    #-------------Fungsi Bannlist Finish------------------#  
              ...
              if msg.from_ in owner:
                ...
                #p1.removeAllMessages(op.param2)
                #p2.removeAllMessages(op.param2)
                #p3.removeAllMessages(op.param2)
                #p4.removeAllMessages(op.param2)
                #p5.removeAllMessages(op.param2)
...
#--------------------------------------------------------
              ...
              if msg.from_ in admin:
                ks.sendImageWithUrl(msg.to,"http://oi66.tinypic.com/344xsle.jpg")
            elif msg.text in ["6pap"]:
              if msg.from_ in admin:
                ka.sendImageWithUrl(msg.to,"http://oi66.tinypic.com/539wzq.jpg")
            elif msg.text in ["7pap"]:
              if msg.from_ in admin:
                kb.sendImageWithUrl(msg.to,"http://oi66.tinypic.com/1sz1vc.jpg")
            elif msg.text in ["8pap"]:
              if msg.from_ in admin:
                ku.sendImageWithUrl(msg.to,"http://oi68.tinypic.com/154d4pt.jpg")
            elif msg.text in ["9pap"]:
              if msg.from_ in admin:
                ke.sendImageWithUrl(msg.to,"http://oi65.tinypic.com/21314rs.jpg")
            elif msg.text in ["10pap"]:
              if msg.from_ in admin:
                ko.sendImageWithUrl(msg.to,"http://oi67.tinypic.com/ptbeq.jpg")
            elif msg.text in ["Bpap"]:
              if msg.from_ in owner:
                G = cl.getGroup(msg.to)
                ginfo = cl.getGroup(msg.to)
                G.preventJoinByTicket = False
                ...
                k2.acceptGroupInvitationByTicket(msg.to,Ticket)
                k2.sendText(msg.to,"Njiiir Ane Di Tinggalin 😭😭😭\Ane Kan Juga Mau Ikutan Pap")
                cl.sendText(msg.to,"Yowes Ojo Ngedumel\nSilahkan Kalian Pap")
                k1.sendImageWithUrl(msg.to,"http://oi66.tinypic.com/2qso4gh.jpg")
                k1.sendText(msg.to,"Done")
                k2.sendImageWithUrl(msg.to,"http://oi68.tinypic.com/24vty1e.jpg")
