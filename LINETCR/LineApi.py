...
class LINE:
  ...
  def login(self, mail=None, passwd=None, cert=None, token=None, qr=False, callback=None):
    ...
    self._headers = {
          ...
          'X-Line-Access' : 'EoKGDl1sAX3qOor1TTy9.287sCnQi3KUtYG1K6dZSYq.+mh9Ke3RKhpBrAMedpi4vfYgitY5SpBEqy6unvuwF3Q=',
          'User-Agent' : 'Mozilla/6.0.0 (Windows NT 6.1; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/63.0.3239.108 Safari/537.36'
    }
